            ...
            <li key={player.id} className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <Avatar className="h-8 w-8">
                  <AvatarFallback className={cn("text-xs", player.isDrawing && "bg-primary text-primary-foreground")}>
              ...
              <div className="flex items-center gap-2">
                {player.isDrawing && <Paintbrush className="h-4 w-4 text-primary" />}
                {player.id === topPlayerId && <Crown className="h-4 w-4 text-yellow-400" />}
